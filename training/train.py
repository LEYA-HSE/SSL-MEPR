...
def train(cfg,
    ...
    if not cfg.single_task:
        ...
        ablation_config = (
            ...
            else {"disabled_modalities": modality_combinations[cfg.id_ablation_type_by_modality]}
        )
