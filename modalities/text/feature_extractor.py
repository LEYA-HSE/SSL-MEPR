...
class PretrainedTextEmbeddingExtractor:
    """
    BGE-small-en-v1.5 → последовательный эмбеддинг (B, T, 384) →
    ...
    def __init__(
        ...
        fusion_ckpt: str = "modalities/text/checkpoints/Mamba_Transformer_bge-small_fusion.pt",
        emo_ckpt: str   = "modalities/text/checkpoints/Mamba_bge-small_emotion.pt",
        per_ckpt: str   = "modalities/text/checkpoints/Transformer_bge-small_personality.pt",
    ):
