...
class PretrainedAudioEmbeddingExtractor:
    def __init__(
        ...
        fusion_ckpt: str = "modalities/audio/checkpoints/best_fusion_overall_mamba.pt",
        emo_ckpt:   str = "modalities/audio/checkpoints/final_best_model_uni_mamba.pt",
        per_ckpt:   str = "modalities/audio/checkpoints/best_mamba_regressor.pth",
