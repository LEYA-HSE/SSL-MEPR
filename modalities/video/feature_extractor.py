...
class PretrainedImageEmbeddingExtractor:
    """
    Wrapper around pretrained fusion models for body, face, and scene.
    Also stores a CLIP processor so other modules can reuse it.
    """
    ...
    def extract(self, *, body_tensor=None, face_tensor=None, scene_tensor=None):
        """
        Returns a dict with features for body, face, and scene.
        """
        results = {}
