...
def main(split, base_path, output_root):
    if split == "train":
        input_dir = Path(base_path) / "train"
    elif split in ["dev", "test"]:
        input_dir = Path(base_path) / "test_full" / split
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_path", default="emo_video")
    parser.add_argument("--output_root", default="emo_video_embeddings")
    args = parser.parse_args()

    main(args.split, args.base_path, args.output_root)
